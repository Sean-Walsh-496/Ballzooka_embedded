...
BLEByteCharacteristic HeadingCharacteristic(HEADING_CHARACTERISTIC_UUID, BLERead);
BLEByteCharacteristic PositionCharacteristic(POSITION_CHARACTERISTIC_UUID, BLERead);
BLEByteCharacteristic BatteryCharacteristic(BATTERY_CHARACTERISTIC_UUID, BLERead);
BLEByteCharacteristic RPMCharacteristic(RPM_CHARACTERISTIC_UUID, BLERead);
